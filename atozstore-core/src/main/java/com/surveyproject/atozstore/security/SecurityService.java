...
public class SecurityService
{
	...
	public String resetPassword(String email)
	{
		...
		if(user == null)
		{
			throw new AToZStoreException("Invalid email address");
		}
	...
	public void updatePassword(String email, String token, String password)
	{
		...
		if(!StringUtils.hasText(token) || !token.equals(user.getPasswordResetToken())){
			throw new AToZStoreException("Invalid password reset token");
		}
	...
	public Role createRole(Role role)
	{
		...
		if(roleByName != null){
			throw new AToZStoreException("Role "+role.getName()+" already exist");
		}
	...
	public Role updateRole(Role role)
	{
		...
		if(persistedRole == null){
			throw new AToZStoreException("Role "+role.getId()+" doesn't exist");
		}
	...
	public User createUser(User user)
	{
		...
		if(userByEmail != null){
			throw new AToZStoreException("Email "+user.getEmail()+" already in use");
		}
	...
	public User updateUser(User user)
	{
		...
		if(persistedUser == null){
			throw new AToZStoreException("User "+user.getId()+" doesn't exist");
		}
