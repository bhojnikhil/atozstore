...
import static com.surveyproject.atozstore.admin.web.utils.MessageCodes.*;
 ...
 */
@Controller
public class UserAuthController extends AToZStoreAdminBaseController
{
	...
	public String handleResetPwd(HttpServletRequest request, Model model, RedirectAttributes redirectAttributes)
	{
		try
		{
			...
			String Pwd = password;
			securityService.updatePassword(email, token, Pwd);
